...
with tab_vpn:
    ...
    if origen_vtd == "Generar escenarios múltiples":
        ...
        st.subheader("3. Cargar archivos VTD manuales")
        ...
        with col_m3:
            ...
            if vtd3_act:
                ...
                if archivo_vtd3:
                    archivos_manuales.append(("Manual 3", archivo_vtd3))
                    ...
                    if archivos_manuales:
                        for etiqueta, archivo in archivos_manuales:
                            try:
                                ...
                                resultados_vpn.append({
                                    "Escenario": f"VTD {etiqueta}",
                                    "VPN Total": vpn_total
                                })
                            except Exception as e:
                                st.error(f"Error al procesar el archivo {etiqueta}: {e}")
                    else:
