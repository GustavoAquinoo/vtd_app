...
# ==========================================
# PESTAÑA 5: CÁLCULO DE VPN
# ==========================================
with tab_vpn:
    st.header("Valor presente neto")
    st.markdown("Calcula el VPN de un flujo de caja mensual descontado con una curva de tasas.")
    ...
    with col_tasa:
        ...
        origen_vtd = st.radio("Origen del vector:", ["Usar curva VTDA del dashboard", "Cargar otro vector de tasas"])
        
        df_vtd_vpn = None
        if origen_vtd == "Usar curva VTDA del dashboard":
