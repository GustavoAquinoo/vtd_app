...
with tab_general:
    ...
    st.sidebar.link_button(
        ...
        url="https://www.sbs.gob.pe/app/pp/n_CurvaSoberana/CurvaSoberana/ConsultaHistorica", # <- Pon tu URL real aquí
        use_container_width=True
    )
    st.sidebar.caption("Accede a las Curvas Cupón Cero de la SBS.")
    # -------------------------
    ...
    if st.session_state.datos_grafico:
        ...
        fig.update_layout(
            yaxis_tickformat='.2f',
            # Movemos la leyenda a la parte superior de forma horizontal
            legend=dict(
                orientation="h", 
                yanchor="bottom", 
                y=1.02, 
            ...
            # Reducimos los márgenes laterales
